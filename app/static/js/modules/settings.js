window.Settings = {
    ...
    open() {
        ...
        // Kibana instances — en col 4, sous ES instances
        const kibanaDivider = document.createElement("div");
        kibanaDivider.className = "argos-divider my-4";
        colMisp.appendChild(kibanaDivider);
        document.getElementById("kibana-instances-section")?.remove();
        window.KibanaInstances?.render?.(colMisp);
    ...
    save() {
        ...
        EsInstances?.collect?.();
        window.KibanaInstances?.collect?.();
